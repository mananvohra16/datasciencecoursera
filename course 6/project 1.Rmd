...
Analytical mean - 4.993867
Theoretical mean - 5
Cetner of distribution is close to the theoretical center of the distribution 
...
hist(means_exponentials,breaks=n,prob=T,col="yellow",xlab = "Means",main="Means Density",ylab="Density")
